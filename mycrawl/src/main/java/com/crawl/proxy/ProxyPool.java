...
public class ProxyPool {
	...
	static {
		...
		for (int i = 1; i <= pages; i++){
			...
			proxyMap.put("http://www.xididaili.com/wn/" + i + ".html", XicidailiProxyListPageParser.class);
			...
			proxyMap.put("http://www.mimiip.com.com/gngao/" + i, MimiipProxyListPageParser.class);//高匿
			...
			for (int j = 1; j < 34; j++) {
				proxyMap.put("http://www.66ip.cn/areindex_" + j + "/" + i + ".html", Ip66ProxyListPageParser.class);
			}
		}
