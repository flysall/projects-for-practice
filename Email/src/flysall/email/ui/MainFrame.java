...
import flysall.email.box.*;
import flysall.email.mail.*;
import flysall.email.mail.MailSender;
import flysall.email.object.*;
import flysall.email.system.*;
import flysall.email.system.SystemLoaderImpl;
...
public class MainFrame extends JFrame {
	...
	//本地中的邮件处理对象
	private SystemHandler systemHandler = (SystemHandler) new SystemHandlerImpl();
	//本地中的邮件加载对象
